        ...
        return (
            <div className="tweet-components">
                ...
                <div className="tweet-tabs">
                    <a href="#" className={!showSavedTweets && 'all-tweets'} onClick={() => { event.preventDefault(); this.setState({ showSavedTweets: false }) }}>Tweets</a>
                    <a href="#" className={showSavedTweets && 'saved-tweets'} onClick={() => { event.preventDefault(); this.setState({ showSavedTweets: true }) }}>Saved Tweets</a>
                </div>
